    ...
    <div class="panel-body">
        ...
        <?= $this->Form->create($user, ['id' => 'user-form', 'class' => 'form-horizontal form-add']) ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?= $this->Form->input('username', ['class' => 'form-control input-90', 'label' => false]) ?>
                </div>
            </div><!--End Username-->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="password" name="password" class="form-control input-90" placeholder="Mật khẩu">
                </div>
            </div><!--END password-->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <span style="color:#ccc">Nếu không muốn đổi mật khẩu, vui lòng không sửa ô nhập!</span>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?= $this->Form->input('email', ['class' => 'form-control input-90', 'label' => false]) ?>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?= $this->Form->button(__('CẬP NHẬT'), ['class' => 'btn btn-primary btn-lg']) ?>
                </div>
            </div><!--End submit-->
